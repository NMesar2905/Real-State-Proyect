...
import com.real.state.pageclases.ProductPage;
import com.real.state.pageclases.SearchResultPage;
import com.real.state.utilities.DateUtils;
import com.real.state.utilities.ExtentReportManager;
	...
	public BaseTest() {
		...
		try {
			FileInputStream fis = new FileInputStream(
					System.getProperty("user.dir") + "\\src\\test\\java\\com\\real\\state\\config\\config.properties");
			prop.load(fis);
		} catch (Exception e) {
			e.printStackTrace();
		}
