...
public class BasePage extends BaseTest {
	...
	public HomePage openApplication() {
		logger.log(Status.INFO, "Opening Metro Cuadrado Webpage");
		driver.get(prop.getProperty("metro-cuadrado"));
		logger.log(Status.PASS, "Succesfully Opened the "+prop.getProperty("metro-cuadrado"));
	...
	public void getTitle(String expectedTitle) {
		try {
			logger.log(Status.INFO, "Verifying the Title Page");
